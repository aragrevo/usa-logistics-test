...
const SERVICES_DATA = [
  {
    ...
    title: 'Importaciones',
    text:
      'Ordinarias, programas especiales, Plan Vallejo, temporales, licencias previas, franquicias, las demás',
  },
  {
    icon: icon2,
    title: 'Exportaciones',
    text:
      'Ordinarias, temporales para perfeccionamiento, temporales para reimportación, re-exportaciones, reembarques, muestras sin valor comercial, las demás.',
  },
  {
    icon: icon3,
